...
public class DigitalStorageOperation extends Operation
{
	...
	private final static GeneralConversion BitToKilobit = new GeneralConversion(1/1000 , 0);
	private final static GeneralConversion KilobitToMegabit = new GeneralConversion(1/1000 , 0);
	...
	private final static GeneralConversion ByteToMegabit = new GeneralConversion(1/125000 , 0);
	private final static GeneralConversion KilobyteToMegabit = new GeneralConversion(1/125 , 0);
	...
	private final static GeneralConversion BitToMegabit = new GeneralConversion(1/1000000 , 0);
	private final static GeneralConversion KilobitToGigabit = new GeneralConversion(1/1000000 , 0);
	private final static GeneralConversion MegabitToGigabit = new GeneralConversion(1/1000 , 0);
	private final static GeneralConversion TerabitToGigabit = new GeneralConversion(1000 , 0);
	private final static GeneralConversion ByteToGigabit = new GeneralConversion(1 /125000000, 0);
	private final static GeneralConversion KilobyteToGigabit = new GeneralConversion(1/125000 , 0);
	private final static GeneralConversion MegabyteToGigabit = new GeneralConversion(1/125 , 0);
	...
	private final static GeneralConversion BitToGigabit = new GeneralConversion(1/1000000000 , 0);
	private final static GeneralConversion KilobitToTerabit = new GeneralConversion(1/1000000000 , 0);
	private final static GeneralConversion MegabitToTerabit = new GeneralConversion(1/1000000 , 0);
	private final static GeneralConversion GigabitToTerabit = new GeneralConversion(1/1000 , 0);
	//private final static GeneralConversion ByteToTerabit = new GeneralConversion(1/125000000000 , 0);
	private final static GeneralConversion KilobyteToTerabit = new GeneralConversion(1/125000000 , 0);
	private final static GeneralConversion MegabyteToTerabit = new GeneralConversion(1/125000 , 0);
	private final static GeneralConversion GigabyteToTerabit = new GeneralConversion(1/125 , 0);
	private final static GeneralConversion TerabyteToTerabit = new GeneralConversion(8 , 0);
	//private final static GeneralConversion BitToTerabit = new GeneralConversion(1/1000000000000 , 0);
	private final static GeneralConversion KilobitToByte = new GeneralConversion(1/125 , 0);
	private final static GeneralConversion MegabitToByte = new GeneralConversion(1/125000 , 0);
	private final static GeneralConversion GigabitToByte = new GeneralConversion(1/125000000 , 0);
	//private final static GeneralConversion TerabitToByte = new GeneralConversion(1/125000000000 , 0);
	...
	private final static GeneralConversion BitToByte = new GeneralConversion(1/8 , 0);
	private final static GeneralConversion KilobitToKilobyte = new GeneralConversion(1/8 , 0);
	...
	private final static GeneralConversion ByteToKilobyte = new GeneralConversion(1/1000 , 0);
	...
	private final static GeneralConversion BitToKilobyte = new GeneralConversion(1/8000 , 0);
	private final static GeneralConversion KilobitToMegabyte = new GeneralConversion(1/8000 , 0);
	private final static GeneralConversion MegabitToMegabyte = new GeneralConversion(1/8 , 0);
	...
	private final static GeneralConversion ByteToMegabyte = new GeneralConversion(1/1000000 , 0);
	private final static GeneralConversion KilobyteToMegabyte = new GeneralConversion(1/1000 , 0);
	...
	private final static GeneralConversion BitToMegabyte = new GeneralConversion(1/8000000 , 0);
	private final static GeneralConversion KilobitToGigabyte = new GeneralConversion(1/8000000 , 0);
	private final static GeneralConversion MegabitToGigabyte = new GeneralConversion(1/8000 , 0);
	private final static GeneralConversion GigabitToGigabyte = new GeneralConversion(1/8 , 0);
	private final static GeneralConversion TerabitToGigabyte = new GeneralConversion(125 , 0);
	private final static GeneralConversion ByteToGigabyte = new GeneralConversion(1/1000000000 , 0);
	private final static GeneralConversion KilobyteToGigabyte = new GeneralConversion(1/1000000 , 0);
	private final static GeneralConversion MegabyteToGigabyte = new GeneralConversion(1/1000 , 0);
	private final static GeneralConversion TerabyteToGigabyte = new GeneralConversion(1000 , 0);
	//private final static GeneralConversion BitToGigabyte = new GeneralConversion(1/8000000000 , 0);
	//private final static GeneralConversion KilobitToTerabyte = new GeneralConversion(1/8000000000 , 0);
	private final static GeneralConversion MegabitToTerabyte = new GeneralConversion(1/8000000 , 0);
	private final static GeneralConversion GigabitToTerabyte = new GeneralConversion(1/8000 , 0);
	private final static GeneralConversion TerabitToTerabyte = new GeneralConversion(1/8 , 0);
	//private final static GeneralConversion ByteToTerabyte = new GeneralConversion(1/1000000000000 , 0);
	private final static GeneralConversion KilobyteToTerabyte = new GeneralConversion(1/1000000000 , 0);
	private final static GeneralConversion MegabyteToTerabyte = new GeneralConversion(1/1000000 , 0);
	private final static GeneralConversion GigabyteToTerabyte = new GeneralConversion(1/1000 , 0);
	//private final static GeneralConversion BitToTerabyte = new GeneralConversion(1 /8000000000000, 0);
